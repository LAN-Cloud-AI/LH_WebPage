    ...
    shots: [
      {
        ...
        width: 3010,
        height: 1644,
        alt: 'Console workspace overview with ingested content, lead scores, a 7-day trend, and intent mix',
        title: 'Workspace overview',
        caption: 'Collection progress, lead scores, and intent mix on one page, with the latest intake trend.',
      },
      {
        src: '/assets/screenshots/console-leads-center.png',
        width: 2994,
        height: 1636,
        alt: 'Console lead center with the master library, ownership, org assignment, and account routing pools',
        title: 'Lead center · three pools',
        caption: 'Master library, ownership, org assignment, and account routing switch on one page. Every lead shows its three-pool counts.',
      },
      {
        src: '/assets/screenshots/console-keywords.png',
        width: 3016,
        height: 1636,
        alt: 'Console keyword management with keyword groups, receiving accounts, and search terms',
        title: 'Keyword groups',
        caption: 'Group monitoring terms and receiving accounts. Collection runs daily at 00:00, and comments can be searched from the list.',
      },
    ],
  },
  app: {
    ...
    cta: 'Get 线索猎手',
    note: 'iOS and Android are both on the 3.0.0 release. Tap the button to download.',
    carousel: 'Sales app screens',
    prev: 'Previous',
    next: 'Next',
    shots: [
      {
