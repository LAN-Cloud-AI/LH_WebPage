...
export const GUIDE = {
  ...
  'zh-Hant': {
    ...
    hint: '點擊配圖可放大查看',
    zoom: '放大：',
    footer: '線索獵手 · 發現購車需求，連接門店與客戶。',
    site: '產品官網',
    console: '進入後台',
    app: '取得 APP',
    contact: '聯繫銷售',
    bannerAria: '聯繫線索獵手銷售',
    bannerKicker: '加入線索獵手銷售經理企業微信',
    bannerTitle: '預約線索獵手演示或開通試用',
    close: '關閉 · Esc',
    tocHeading: '閱讀導覽',
    quick: '快速入口',
    nav: [
      ['#what', '線索獵手是什麼'],
      ['#why', '為什麼有 DCC 和汽車垂媒，還需要線索獵手'],
  ...
  en: {
    ...
    downloadPdfShort: 'PDF',
    eyebrow: 'LEADSHUNTER · Illustrated guide',
    h1: 'LeadsHunter',
    ...
    bannerAria: 'Contact LeadsHunter sales',
    bannerKicker: 'Add the LeadsHunter sales manager on WeCom',
...
export const CONTACT = {
  ...
  'zh-Hant': {
    title: '聯繫線索獵手銷售',
    description:
      '預約產品演示、開通門店試用或了解合作方案。電話、郵件或企業微信聯繫線索獵手銷售經理。',
    h1: '聯繫線索獵手<wbr>銷售',
    lede: '預約產品演示、開通門店試用，<br>或了解合作方案。<br>銷售經理會在工作時間回覆。',
    guide: '產品介紹',
    qrAlt: '線索獵手銷售經理企業微信二維碼，長按識別',
    qrTitle: '長按識別二維碼',
    qrHint: '加入線索獵手銷售經理<br>企業微信',
    phone: '電話',
    mail: '郵件',
    site: '產品官網',
    handbook: '圖文手冊',
  ...
  en: {
    ...
    description:
      'Book a product demo, start a store trial, or talk through a partnership. Call, email, or add the LeadsHunter sales manager on WeCom.',
    ...
    guide: 'Product guide',
    qrAlt: 'WeCom QR code for the LeadsHunter sales manager',
    qrTitle: 'Scan the QR code',
    qrHint: 'Add the LeadsHunter sales manager<br>on WeCom',
    phone: 'Phone',
    mail: 'Email',
    site: 'Official site',
