...
`npm run check` 执行类型检查、官网构建、主题测试、三语手册/PDF、联系页构建与 SEO 校验。GitHub Actions 在 PR、main 和版本标签上执行相同检查。官网采用独立版本号；产品版本与安装渠道分别记录。iOS 与 Android 均为 3.0.0 正式版，从应用商店按钮下载。
